...
// TODO Hardware check fo Atlas MIPS 4kc
...
// TODO Hardware check fo Atlas MIPS 4kc
#define ATLAS_HARD_INT(x)        (1 << (x))

#define MAX_INTERRUPT 7
...
namespace grlib
{
  ...
  private:
    ...
    ATLAS_irqmp_registers *irqmp_regs; //!<IRQMP Internal Registers
